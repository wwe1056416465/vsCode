...
suite('markdown.WorkspaceSymbolProvider', () => {
    ...
    test('Should update results when markdown file is created', async () => {
        ...
        assert.strictEqual((await provider.provideWorkspaceSymbols('')).length, 1);
        // Creat file
        workspaceFileProvider.createDocument(new inMemoryDocument_1.InMemoryDocument(vscode.Uri.parse('test2.md'), `# new header\nabc\n## header2`));
        const newSymbols = await provider.provideWorkspaceSymbols('');
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/0f080e5267e829de46638128001aeb7ca2d6d50e/extensions\markdown-language-features\out/test\workspaceSymbolProvider.test.js.map

    ...
    checkIgnoreSoon() {
        ...
        for (const [, item] of queue) {
            ...
            item.repository.checkIgnore(paths).then(ignoreSet => {
                ...
                if (err.gitErrorCode !== git_1.GitErrorCodes.IsInSubmodule) {
                    console.error(err);
                }
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/0f080e5267e829de46638128001aeb7ca2d6d50e/extensions\git\out/decorationProvider.js.map
